...
const sessionName = 'ash'
const donet = 'HII I am ash'
const owner = ['923258787253']
...
async function startHisoka() {
    ...
    console.log(color(figlet.textSync('GURU', {
		font: 'Standard',
    ...
    client.ev.on('messages.upsert', async chatUpdate => {
        ...
        try {
            ...
            require("./guru")(client, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
    ...
    client.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            else if (reason === DisconnectReason.loggedOut) { console.log(`Device Logged Out, Please Delete Session file GURU.json and Scan Again.`); process.exit(); }
