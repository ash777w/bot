...
module.exports = async (Miku, m, commands, chatUpdate, store) => {
  ...
  try {
    ...
    const isMaster = [botNumber, ...global.senpai]
    ...
    global.suppL = `_\n\n*🐉Support group🐉*"https://chat.whatsapp.com/L5YDCDHXWtyApDuJYT9Pk5"_\n\n*🌀Casino group🌀* "https://chat.whatsapp.com/C6i6m8l3dmvLmdi54WqSQz";\n\n`
   ...
   let ECONOMYstatus = "false";

    if (economystatus) {

      ECONOMYstatus = economystatus.switchECONOMY || "false";
   ...
   let SUPPORTstatus = "false";
    ...
    if (body.startsWith(prefix) && !icmd) {
      ...
      let mikutext = `This doesn't look like one of my commands *${pushname}* senpai! Did James Darrel from men in black use the neuralyzer on you?. Use *${prefix}help* to get my full command list!\n`;
      const reactmxv = {
